...
:::footer
Seninge, et al. VEGA. _Nature Communications_ (2021). doi:[10.1038/s41467-021-26017-0)](https://doi.org/10.1038/s41467-021-26017-0)
:::
...
...and various other repos you can `git clone`.

. . .

Nothing for R... [yet](https://torch.mlverse.org/)!

## The binn package - installation {.smaller}

```bash
pip install binn==0.1.1
```
...
- matrix ($n \times p$) of omics data
:::
:::column
### `mapping`, `pathways`

1. 2 column matrix: (feature, pathway)
2. 2 column matrix: (parent, child)

[Or set `use_reactome=True`]{style="font-size: small;"}
:::
:::column
### `design_matrix`
...
[e.g. binary classification, group $\in \{1,2\}$]{style="font-size: small;"}
:::
::::
